...
Session update: async chat completions now support streaming (future resolves to `Dedalus::Stream` of chunks); next focus is schema helpers/introspection and then moving on to remaining resource modules with async parity.
