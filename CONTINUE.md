...
Recent progress: file upload helpers now mirror `_files.py` (via `Dedalus::FileUpload`), async/sync parity tests cover embeddings plus streaming chat payloads, and CI now runs lint + tests across Perl 5.36/5.38.
