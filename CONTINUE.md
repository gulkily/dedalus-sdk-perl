...
1. Finish any remaining types under `lib/Dedalus/Types/*` (we now cover chat streaming chunks + response output blocks; next up are tool call payloads, image/audio structured pieces from `docs/api/schemas.md`).
